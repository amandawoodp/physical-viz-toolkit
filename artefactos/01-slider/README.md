...
5. **Calibra:** cubo al extremo 0 del canal → toca **Calibrar extremo 0**. Luego cubo al extremo 4 → toca **Calibrar extremo 4**.
6. Desliza el cubo. El computador muestra 0, 1, 2, 3 o 4 según en qué parte del canal se encuentre el cubo.
...
- El canal debe tener suficiente largo para que los extremos 0 y 4 queden bien separados en cámara.
